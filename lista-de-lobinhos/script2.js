document.addEventListener('DOMContentLoaded', () => {
    ...
    function verificarEIniciar() {
        ...
        if (localStorage.getItem('lobos')) {
            console.log('Dados encontrados no localStorage, iniciando aplicação');
            // dados foi encontrados, inicia a aplicação
            iniciarAplicacaoPrincipal();
        } else {
            console.log('Dados ainda não prontos, aguardando...');
    ...
    function iniciarAplicacaoPrincipal() {
        ...
        console.log('Total de lobos carregados:', todosOsLobos.length);
        ...
        function aplicarFiltros() { 
            ...
            console.log('Lobos após filtro de adoção:', lobosFiltrados.length);
            ...
            if (termoPesquisa) {
                ...
                console.log('Lobos após busca por nome:', lobosFiltrados.length);
            }
...
function cliqueLobo(event) {
    // Verifica se clicou no botão adotar
    ...
    // Se não clicou no botão, verifica se clicou no card para ir para a página de detalhes
